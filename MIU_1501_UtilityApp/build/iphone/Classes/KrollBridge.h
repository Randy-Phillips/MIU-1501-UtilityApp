...
@interface MIU_1501_UtilityAppObject : KrollCoverageObject {
#else
@interface MIU_1501_UtilityAppObject : KrollObject {
#endif
@private
...
extern NSString * MIU_1501_UtilityApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	MIU_1501_UtilityAppObject *_miu_1501_utilityapp;
    KrollObject* console;
	BOOL shutdown;
