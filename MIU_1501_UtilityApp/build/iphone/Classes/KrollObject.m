...
//@interface MIU_1501_UtilityAppObject : NSObject
//@end

@interface MIU_1501_UtilityAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MIU_1501_UtilityAppObject class]])
		{
			for (NSString *key in [[(MIU_1501_UtilityAppObject*)o modules] allKeys])
			{
