...
/**
 Base class for all MIU_1501_UtilityApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the MIU_1501_UtilityApp view hierarchy (such as wrapped iOS UIViews) was touched.
