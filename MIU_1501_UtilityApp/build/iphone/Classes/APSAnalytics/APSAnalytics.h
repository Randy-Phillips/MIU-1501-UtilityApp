 ...
 * to send analytic data that can be viewed on the MIU_1501_UtilityApp Dashboard.
 *
 * For information on getting started with MIU_1501_UtilityApp Platform Services,
