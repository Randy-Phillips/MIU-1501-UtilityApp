...
/**
 The base class for all MIU_1501_UtilityApp modules
 */
...
/**
 MIU_1501_UtilityApp Platform calls this method on startup.
 */
-(void)startup;

/**
 MIU_1501_UtilityApp Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 MIU_1501_UtilityApp Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 MIU_1501_UtilityApp Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 MIU_1501_UtilityApp Platform calls this method on resume.
 @param sender The sender of the event.
 */
