...
// in simulator we redefine to format for MIU_1501_UtilityApp Developer console
...
{\
	NSString * exceptionName = [@"org.miu_1501_utilityapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.miu_1501_utilityapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMIU_1501_UtilityAppNativeItemNone = -1, 
	UIMIU_1501_UtilityAppNativeItemSpinner = -2,
	UIMIU_1501_UtilityAppNativeItemProgressBar = -3,
	
	UIMIU_1501_UtilityAppNativeItemSlider = -4,
	UIMIU_1501_UtilityAppNativeItemSwitch = -5,
	UIMIU_1501_UtilityAppNativeItemMultiButton = -6,
	UIMIU_1501_UtilityAppNativeItemSegmented = -7,
	
	UIMIU_1501_UtilityAppNativeItemTextView = -8,
	UIMIU_1501_UtilityAppNativeItemTextField = -9,
	UIMIU_1501_UtilityAppNativeItemSearchBar = -10,
	
	UIMIU_1501_UtilityAppNativeItemPicker = -11,
	UIMIU_1501_UtilityAppNativeItemDatePicker = -12,
	
	UIMIU_1501_UtilityAppNativeItemInfoLight = -13,
	UIMIU_1501_UtilityAppNativeItemInfoDark = -14,
	
	UIMIU_1501_UtilityAppNativeItemDisclosure = -15,
	
	UIMIU_1501_UtilityAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all MIU_1501_UtilityApp instances of
